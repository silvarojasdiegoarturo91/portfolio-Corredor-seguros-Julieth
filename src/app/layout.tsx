...
export const metadata: Metadata = {
  ...
  description: 'Especialistas en seguros de vida, salud, mascotas y hogar en España. Más de 10 años protegiendo familias con soluciones personalizadas.',
  keywords: ['seguros españa', 'seguro de vida', 'seguro de salud', 'corredor de seguros', 'Julieth seguros', 'mediador de seguros'],
  openGraph: {
    type: 'website',
    locale: 'es_ES',
  ...
  twitter: {
    ...
    description: 'Especialistas en seguros en España.',
  },
  robots: {
    index: true,
    follow: true,
