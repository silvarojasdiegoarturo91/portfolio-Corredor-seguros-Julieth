...
const contactInfo = [
  ...
  { icon: '✉️', title: 'Email', value: 'contacto@juliethperezseguros.com', href: 'mailto:contacto@juliethperezseguros.com' },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-green-50 border-2 border-green-200 rounded-xl p-6 text-center">
                ...
                <a
                  href="https://wa.me/34695135678?text=Hola%20Julieth%2C%20me%20gustar%C3%ADa%20obtener%20informaci%C3%B3n%20sobre%20seguros."
                  target="_blank"
